  ...
  return (
    <div className='flex justify-center flex-col gap-5 container mx-auto p-8 w-100 relative rounded-md shadow-2xl border-1 border-white/10 bg-[#303030]'>
      <form className='flex flex-col gap-5 w-full' onSubmit={handleSubmit}>
        ...
        <div>
          <p className='text-white/80 font-semibold mb-1'>Password</p>
        ...
        <button className='mt-3 w-full bg-[#1f1f1f] border-1 border-transparent rounded-md p-1.5 px-2 cursor-pointer text-white/80 transition-all duration-250 hover:border-white/50' type="submit">Sign Up</button>
